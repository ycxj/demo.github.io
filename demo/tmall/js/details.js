window.onload = function () {
    ...
    var dataName,
        ...
        dataNum = sessionStorage.getItem("productNum"),
    ...
    function setDetails(){
        tmPrice.innerHTML = dataName[dataNum].price;
        detailsTitle.innerHTML = dataName[dataNum].title;
        saleCount.innerHTML = dataName[dataNum].volume;
        commentCount.innerHTML = dataName[dataNum].comment;
        reviewsCount.innerHTML = dataName[dataNum].comment;
        smallImg.src = "images/product/" + categoryClass + "/" + dataName[dataNum].smallImg;
        bigImg.src =  "images/product/" + categoryClass + "/" + dataName[dataNum].bigImg;
        var parameterLists = dataName[dataNum].parameter;
        ...
        var descripeImg = dataName[dataNum].descripeImg;
        for(let i = 0 ; i < descripeImg.length ; i++){
            let img = document.createElement("img");
            img.src = "images/product/" + categoryClass + "/" + descripeImg[i];
    ...
    linkBasket.onclick = function(){
        ...
        function addProductCart(){
            ...
            var item = localStorage.getItem("itemList"),
                checkItem = categoryClass + "-" + dataNum;
            //判断是否存在itemList
            ...
            if(item==null){
                ...
                let checkItemNameIndex = checkItemList.indexOf(checkItem);
        ...
        function addItem(arr,originalAmount,itemIndex){
            let currentAmount = Number(productAmount.value),
                ...
                itemName = categoryClass + "-" + dataNum + "_" + amount;
            if(itemIndex == null){
                arr.push(itemName);
            }else{
